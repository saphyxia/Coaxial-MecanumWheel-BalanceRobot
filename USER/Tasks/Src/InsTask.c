...
//    }
    ...
    imu_start_dma_flag = 1;
		...
		for(;;)
		{
			...
			Imu.pit_angle = INS_angle[1] *180.f/3.1415926f;
			Imu.rol_angle = INS_angle[2] *180.f/3.1415926f;
			Imu.yaw_gyro = bmi088_real_data.gyro[2] *50.f;
			Imu.pit_gyro = bmi088_real_data.gyro[1] *50.f;
			Imu.rol_gyro = bmi088_real_data.gyro[0] *50.f;
...
void USER_DMA2_Stream2_IRQHandler(void)
{
